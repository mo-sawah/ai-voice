...
<div id="ai-voice-player-wrapper">
    <div class="ai-voice-player-container" data-theme="light">
        <div class="player-inner-flex">
            ...
            <!-- Summary Button -->
            <button class="summary-button" id="ai-voice-summary-btn" aria-label="Generate Article Summary">
        ...
        <div id="ai-voice-summary-section" class="summary-section" style="display: none;">
            <div class="summary-header">
                <h4 class="summary-title">Key Takeaways</h4>
                <button id="ai-voice-summary-close" class="summary-close-btn" aria-label="Close Summary">
